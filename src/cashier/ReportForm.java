...
public class ReportForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ReportTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sale Details ID", "Sales ID", "Customer Name", "Product Name", "Category", "Sub Category", "Quantity", "Amount", "Date"
            }
        ) {
        ...
        BackBttn9.setText("Product List");
    ...
    private void SearchBttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBttnActionPerformed
        // TODO add your handling code here:
          ...
          ReportTable.setModel(new DefaultTableModel(null,new String[]{"Sale Details ID","Sale ID","Customer Name","Product Name","Category","SubCategory","Quantity","Amount","Date"}));
...
"                    inventory.SubCategory,sale_details.Sales_Quantity,sale_details.Total_Amount,sales.Sales_Date\n" +
...
"                    JOIN inventory ON sale_details.Prod_ID=inventory.Prod_ID JOIN products ON inventory.Product_ID=products.Product_ID where\n" +
"                    (sales.Sales_Date BETWEEN ? AND ?) AND sales.Done_By=? ORDER BY Sale_detail_ID DESC ");
           ...
           while(rslt.next()){
             ...
             String tbData []={ID,I,N,P,C,S,Q,A,D};
